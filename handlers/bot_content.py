...
DEFAULTS = {
    ...
    "deposit_send_to": "📱 Send {amount} ETB to this TeleBirr number:\n\n📞 *{phone}*\n\nAfter sending, enter the Transaction Number from your receipt:",
    "deposit_admin_offline": "⚠️ Deposits are temporarily unavailable. Please try again later.",
    "deposit_submit_error": "⚠️ We could not send your deposit request right now. Please try again in a moment. If it keeps failing, contact support.",
