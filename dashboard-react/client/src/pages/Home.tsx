...
export default function Home() {
  ...
  return <div className="min-h-[calc(100vh-56px)] bg-[linear-gradient(180deg,#0D1117_0%,#0A1628_40%,#111827_100%)] pb-4">
    ...
    <section className="mb-6 px-4"><div className="grid grid-cols-2 gap-3"><button onClick={() => play(10)} disabled={!player} className="rounded-2xl bg-gradient-to-br from-[#10B981] to-[#059669] p-4 text-center shadow-[0_8px_25px_rgba(16,185,129,0.3)] transition-transform active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-55"><div className="mb-1 text-2xl">🎮</div><div className="text-lg font-black text-white">10 ETB</div><div className="mt-1 text-[10px] text-white/80">Standard</div></button><button onClick={() => play(20)} disabled={!player} className="rounded-2xl bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] p-4 text-center shadow-[0_8px_25px_rgba(139,92,246,0.3)] transition-transform active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-55"><div className="mb-1 text-2xl">🎯</div><div className="text-lg font-black text-white">20 ETB</div><div className="mt-1 text-[10px] text-white/80">High Stakes</div></button></div><p className="mt-2 text-center text-[10px] text-white/40">Max 2 cartelas · Derash = (Cartelas × Stake × 0.75) / Winners</p></section>
