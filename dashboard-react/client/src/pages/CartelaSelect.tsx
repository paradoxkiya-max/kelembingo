...
export default function CartelaSelect() {
  ...
  return <div className="flex min-h-[calc(100vh-56px)] flex-col bg-[linear-gradient(180deg,#0d0f22_0%,#151833_40%,#0d0f22_100%)]">
    ...
    {expired && <div className="mx-3 mb-1 rounded-xl border border-amber-400/25 bg-amber-500/10 px-3 py-2 text-center text-[11px] font-semibold text-amber-200" role="status">This round is no longer accepting selections. Choose another stake to enter the next round.</div>}
